...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull DrawerLayout rootView, @NonNull ImageView backgroundLogo,
      @NonNull ImageButton btnMenu, @NonNull DrawerLayout drawerLayout,
      @NonNull ConstraintLayout mainContentContainer,
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((DrawerLayout) rootView, backgroundLogo, btnMenu, drawerLayout,
          mainContentContainer, navHostFragment, navView, toolbar);
    }
